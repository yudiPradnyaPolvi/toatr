      ...
      <div className={styles.cards}>
        ...
        <div className={styles.otherBlog}>
          ...
          <div className={styles.containerBlog}>
            <a className={styles.linkBlog} href="./Blog5">
              <img src="/public/pemandangan.jpeg"></img>

              <h4>What is a Melukat Ceremony or Purification Ritual?</h4>
            </a>
          </div>
          <div className={styles.containerBlog}>
            <a className={styles.linkBlog} href="./Blog6">
              <img src="/public/pemandangan.jpeg"></img>

              <h4>Lahangan Sweet: Bali’s Hidden Gem with Breathtaking Views</h4>
            </a>
          </div>
          <div className={styles.containerBlog}>
            <a className={styles.linkBlog} href="./Blog1">
              <img src="/public/pemandangan.jpeg"></img>
